...
namespace NativeWebSocket
{
  ...
  public delegate void WebSocketMessageDirectlyEventHandler(byte[] buffer, int start, int length);
  ...
  public interface IWebSocket
  {
    ...
    event WebSocketMessageDirectlyEventHandler OnMessageDirectly;
    event WebSocketErrorEventHandler OnError;
    event WebSocketCloseEventHandler OnClose;

    WebSocketState State { get; }

    public void EnableDispatchQueue(bool enable);
  }
  ...
  public class WebSocket : IWebSocket {
	...
	public event WebSocketMessageDirectlyEventHandler OnMessageDirectly;
  ...
  public class WebSocket : IWebSocket
  {
    ...
    {
      if (!useDispatchQueue || m_MessageList.Count == 0)
      {
        return;
      }
